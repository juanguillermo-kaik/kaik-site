...
function normalize(value: unknown): PostInput | null {
  ...
  return {
    ...
    author: typeof input.author === "string" && input.author.trim() ? input.author.trim() : "KAIK",
    cover_image: typeof input.cover_image === "string" ? input.cover_image.trim() : null,
    cover_alt: typeof input.cover_alt === "string" ? input.cover_alt.trim() : null,
    og_image: typeof input.og_image === "string" ? input.og_image.trim() : null,
